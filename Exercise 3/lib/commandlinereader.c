...
Arguments:
  'control' should be an integer that is 0 if it is reading from stdin, or 1 if it reads from a given buffer
...
*/
int readLineArguments(int control, char **argVector, int vectorSize, char *buffer, int bufferSize)
{
  int numTokens = 0;
  char *s = " \r\n\t";
